...
export const sv_original_heroesOfMightAndMagic = new SuperVersion(g_heroesOfMightAndMagic,versionEnum.original, "", undefined);
export const sv_original_heroesOfMightAndMagic2 = new SuperVersion(g_heroesOfMightAndMagic2,versionEnum.original, "", undefined);
export const sv_original_heroesOfMightAndMagic3 = new SuperVersion(g_heroesOfMightAndMagic3,versionEnum.original, "", undefined);
export const sv_original_heroesOfMightAndMagic4 = new SuperVersion(g_heroesOfMightAndMagic4,versionEnum.original, "", undefined);
...
export const sv_remaster2012_ageOfEmpires2 = new SuperVersion(g_ageOfEmpires2,versionEnum.remaster, "HD Edition", 2012);
export const sv_remaster2017_ageOfEmpires2 = new SuperVersion(g_ageOfEmpires2,versionEnum.remaster, "Definitive Edition", 2017);
...
export const sv_original_redDeadRedemptionUndeadNightmare = new SuperVersion(g_redDeadRedemptionUndeadNightmare,versionEnum.original, "", 2010);
export const sv_enhanced2016_redDeadRedemptionUndeadNightmare = new SuperVersion(g_redDeadRedemptionUndeadNightmare,versionEnum.enhanced, "", 2016);
