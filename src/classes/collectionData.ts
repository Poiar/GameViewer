import {
  ...
  gv_X360_physical_enhanced2018_redDeadRedemption,
...
const c_PS2_physical_indigoProphecy = new Collection(
  "Indigo Prophecy",
  [gv_PS2_physical_original_indigoProphecy],
  [],
  mediaEnum.dvd,
...
const c_Xbox_physical_indigoProphecy = new Collection(
  "Indigo Prophecy",
  [gv_Xbox_physical_original_indigoProphecy],
  [],
  mediaEnum.dvd,
...
const c_X360_physical_indigoProphecy = new Collection(
  "Indigo Prophecy",
  [gv_X360_physical_enhanced_indigoProphecy],
  [],
  mediaEnum.dvd,
...
const c_X360_digital_indigoProphecy = new Collection(
  "Indigo Prophecy",
  [gv_X360_digital_enhanced_indigoProphecy],
  [],
  mediaEnum.digital,
...
const c_PC_steam_fahrenheitIndigoProphecyRemastered = new Collection(
...
const c_PS4_physical_indigoProphecy = new Collection(
  "Indigo Prophecy: Limited Run #331",
  [gv_PS4_physical_remastered_indigoProphecy],
  [],
  mediaEnum.digital,
  2020,
...
const c_XONE_digital_TheWitcher3 = new Collection(
  "The Witcher 3: Wild Hunt",
  [gv_XONE_digital_original_theWitcher3, gv_XSX_digital_enhanced_theWitcher3],
  [],
  mediaEnum.na,
  2015,
);
...
const c_XONEXSXXSS_digital_TheWitcher3goty = new Collection(
  "The Witcher 3: Wild Hunt - Game of the Year Edition",
  [gv_XONE_digital_original_theWitcher3Goty, gv_XSX_digital_enhanced_theWitcher3Goty],
  [
    dv_XSX_Enhanced_theWitcher3goty_heartsOfStone,
    dv_XSX_Enhanced_theWitcher3goty_bloodAndWine,
    dv_XONE_original_theWitcher3goty_heartsOfStone,
