...
- Name: app.component.spec.ts >> AppComponent >> app is running banner visible
...
Locator: locator('text=gameViewer app is running!')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=gameViewer app is running!')
