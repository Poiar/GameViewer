...
- Name: game-ui.component.spec.ts >> GameUIComponent >> displays a game title
- Location: e2e\game-ui.component.spec.ts:12:7
...
Locator: locator('[cy-data=\'game-ui-3000\']')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[cy-data=\'game-ui-3000\']')
