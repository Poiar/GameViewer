...
- Name: app.component.spec.ts >> AppComponent >> game-ui component is rendered
- Location: e2e\app.component.spec.ts:33:7
...
Call log:
  ...
  - waiting for locator('app-game-ui')
