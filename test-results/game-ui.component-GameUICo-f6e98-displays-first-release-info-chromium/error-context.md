...
- Name: game-ui.component.spec.ts >> GameUIComponent >> displays first release info
- Location: e2e\game-ui.component.spec.ts:16:7
...
Locator: locator('[cy-data=\'game-ui-4000\']')
Expected substring: "First release:"
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('[cy-data=\'game-ui-4000\']')
