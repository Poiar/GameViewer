...
- Name: game-ui.component.spec.ts >> GameUIComponent >> displays game versions heading
- Location: e2e\game-ui.component.spec.ts:24:7
...
Locator: locator('[cy-data=\'game-ui-7000\']')
...
Call log:
  ...
  - waiting for locator('[cy-data=\'game-ui-7000\']')
