...
- Name: app.component.spec.ts >> AppComponent >> game versions section heading visible
- Location: e2e\app.component.spec.ts:24:7
...
Locator: getByRole('heading', { name: 'GameVersions=>DlcVersions' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'GameVersions=>DlcVersions' })
