...
- Name: app.component.spec.ts >> AppComponent >> page title is set
- Location: e2e\app.component.spec.ts:8:7
...
Expected pattern: /gameViewer/
Received string:  "GameViewer"
Timeout: 5000ms

Call log:
  - Expect "toHaveTitle" with timeout 5000ms
    14 × unexpected value "GameViewer"
