...
- Name: game-ui.component.spec.ts >> GameUIComponent >> displays genre info
- Location: e2e\game-ui.component.spec.ts:20:7
...
Locator: locator('[cy-data=\'game-ui-5000\']')
Expected substring: "Genre:"
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('[cy-data=\'game-ui-5000\']')
