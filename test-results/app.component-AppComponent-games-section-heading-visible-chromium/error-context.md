...
- Name: app.component.spec.ts >> AppComponent >> games section heading visible
- Location: e2e\app.component.spec.ts:16:7
...
Locator: getByRole('heading', { name: 'Games=>Super versions' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Games=>Super versions' })
