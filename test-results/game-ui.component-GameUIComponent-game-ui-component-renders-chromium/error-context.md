...
- Name: game-ui.component.spec.ts >> GameUIComponent >> game-ui component renders
- Location: e2e\game-ui.component.spec.ts:8:7
...
Locator: locator('[cy-data=\'game-ui-1000\']')
Expected: "game-ui works!"
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toHaveText" with timeout 5000ms
  - waiting for locator('[cy-data=\'game-ui-1000\']')
