...
- Name: app.component.spec.ts >> AppComponent >> collections section heading visible
- Location: e2e\app.component.spec.ts:12:7
...
Locator: getByRole('heading', { name: 'Collections=>GameVersions and DlcVersions' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Collections=>GameVersions and DlcVersions' })
