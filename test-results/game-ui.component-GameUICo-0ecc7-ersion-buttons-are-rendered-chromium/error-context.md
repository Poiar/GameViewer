...
- Name: game-ui.component.spec.ts >> GameUIComponent >> game version buttons are rendered
- Location: e2e\game-ui.component.spec.ts:28:7
...
Locator: locator('[cy-data=\'game-ui-10000\']').first()
Expected: visible
Timeout: 5000ms
