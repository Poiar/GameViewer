import { pgTable, serial, varchar, text, integer, smallint, boolean, timestamp, jsonb, date, decimal, primaryKey, uniqueIndex, } from "drizzle-orm/pg-core";
// ============================================================
// Lookup tables
// ============================================================
...
export const editionTypes = pgTable("edition_types", {
    id: serial("id").primaryKey(),
    name: varchar("name", { length: 100 }).notNull(),
    slug: varchar("slug", { length: 100 }).notNull().unique(),
}, (table) => ({
...
// Master Games
// ============================================================
export const masterGames = pgTable("master_games", {
    id: serial("id").primaryKey(),
    ...
    hltbTime: smallint("hltb_time"),
    criticScore: smallint("critic_score"),
    summary: text("summary"),
    screenshots: jsonb("screenshots").default([]).notNull(),
    gameModes: jsonb("game_modes").default([]).notNull(),
    playerPerspectives: jsonb("player_perspectives").default([]).notNull(),
...
// ============================================================
export const masterGameGenres = pgTable("master_game_genres", {
...
// ============================================================
export const dlcReleaseCompatibility = pgTable("dlc_release_compatibility", {
...
// ============================================================
export const collectionDlcReleases = pgTable("collection_dlc_releases", {
    collectionId: integer("collection_id")
        .notNull()
        .references(() => collections.id, { onDelete: "cascade" }),
    dlcReleaseId: integer("dlc_release_id")
