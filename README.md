...
| `app-collection-detail-page` | `pages`        |
| `app-collections-page`       | `pages`        |
| `app-dashboard-page`         | `pages`        |
| `app-dlc-detail-page`        | `pages`        |
| `app-dlc-page`               | `pages`        |
| `app-favorites-page`         | `pages`        |
| `app-game-detail-page`       | `pages`        |
| `app-games-page`             | `pages`        |
| `app-inventory-page`         | `pages`        |
| `app-platforms-page`         | `pages`        |
| `app-providers-page`         | `pages`        |
| `app-series-detail-page`     | `pages`        |
| `app-series-page`            | `pages`        |
| `app-stats-page`             | `pages`        |
| `app-timeline-page`          | `pages`        |
| `app-versions-page`          | `pages`        |
| `app-profile`                | `profile`      |
| `app-empty-state`            | `shared`       |
| `app-error-console`          | `shared`       |
| `app-error-state`            | `shared`       |
| `app-global-search`          | `shared`       |
...
| `favorites.service.spec.ts.service.ts`     |                                                    |
| `favorites.service.ts`                     | Favorites/wishlist                                 |
| `games.service.spec.ts.service.ts`         |                                                    |
...
| `lint:css`      | stylelint "src/\*_/_.css"                                                                                                                      |
...
SGDB_API_KEY=
# IGDB (Twitch API v4) — get from https://dev.twitch.tv/console/apps
IGDB_CLIENT_ID=
IGDB_ACCESS_TOKEN=
# RapidAPI — get from https://rapidapi.com/opencritic-opencritic-default/api/opencritic-api
RAPIDAPI_KEY=
```
...
_Auto-generated README built 2026-09-24._

_Run `npm run build-readme` to regenerate._
