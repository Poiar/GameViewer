...
- Name: app.component.spec.ts >> AppComponent >> all 10 series are displayed
- Location: e2e\app.component.spec.ts:36:7
...
Locator:  locator('h1:text(\'Series=>Games\') ~ div h3 a')
Expected: 10
Received: 0
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('h1:text(\'Series=>Games\') ~ div h3 a')
  ...
  - generic [ref=e4]:
    ...
    - generic [ref=e6]:
      ...
      - generic [ref=e10]:
        ...
        - list [ref=e14]:
          - button "Remaster (Win)" [ref=e15]
        - list [ref=e16]:
          - button "Remaster (Win)" [ref=e17]
  - heading "Collections=>GameVersions and DlcVersions" [level=1] [ref=e18]
  - heading "Games=>Super versions" [level=1] [ref=e19]
  - heading "Series=>Games" [level=1] [ref=e20]
  - heading "GameVersions=>DlcVersions" [level=1] [ref=e21]
```
