...
- Name: app.component.spec.ts >> AppComponent >> collection links are displayed
- Location: e2e\app.component.spec.ts:86:7
...
Locator: locator('h1:text(\'Collections=>GameVersions and DlcVersions\') ~ div h3 a').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('h1:text(\'Collections=>GameVersions and DlcVersions\') ~ div h3 a').first()
