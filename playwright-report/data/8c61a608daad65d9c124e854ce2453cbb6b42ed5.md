...
- Name: app.component.spec.ts >> AppComponent >> next steps section is present
- Location: e2e\app.component.spec.ts:78:7
...
Locator: locator('h2:text(\'Next Steps\')')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('h2:text(\'Next Steps\')')
