...
- Name: app.component.spec.ts >> AppComponent >> game super version buttons are rendered
- Location: e2e\app.component.spec.ts:90:7
...
Locator: locator('h1:text(\'Games=>Super versions\') ~ div h3 a').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('h1:text(\'Games=>Super versions\') ~ div h3 a').first()
