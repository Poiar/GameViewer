...
- Name: app.component.spec.ts >> AppComponent >> terminal shows default command
- Location: e2e\app.component.spec.ts:82:7
...
Locator: locator('pre:text(\'ng generate component xyz\')')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('pre:text(\'ng generate component xyz\')')
